...
garden_harvestT <- garden_harvest %>% 
  ...
  ungroup() %>% 
  mutate(variety = fct_reorder(variety, daily_harvest, sum, .desc = TRUE), cumHarv = cumsum(daily_harvest)) 
